...
function renderTerminalStream(buf, opts = {}) {
    ...
    if (!opts.keepBlankLines) {
        // Devices like FortiGate emit a spurious \r\n between a command's
        // output and the next prompt. Collapse any blank line(s) that
        // immediately precede a prompt-shaped line (starts with non-space,
        // contains a shell sigil # $ > % followed by space).
